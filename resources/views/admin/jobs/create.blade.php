...
@section('content')
<form action="{{route('jobs.store')}}" id="post_form_id" class="row" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-3">
        <div class="card card-default form-group ">
            ...
            <div class="card-body">
                ...
                <div class="form-group row gk-align-center">
                <label for="publish_at" class="col-md-4 pl-1 pr-1">Publish At</label>
                    <div id="published_at">
                ...
                <div class="form-group row gk-align-center">
                <label for="publish_at" class="col-md-4 pl-1 pr-1">Expire At</label>
                    <div id="published_at">
...
<input type="hidden" value="{{route('jobs.search.tags')}}" id="tag_search_request_route">
