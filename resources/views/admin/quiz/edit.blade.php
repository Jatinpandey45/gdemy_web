...
@section('content')
<form action="{{route('posts.update',$id)}}" id="post_form_id" class="row" method="POST" enctype="multipart/form-data">
        ...
        <div class="card card-default form-group">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" class="validate[required]" rows="5" name="post_short_desc">{{old('post_short_desc',$post->post_short_desc)}}</textarea>
    ...
    <div class="card card-default form-group">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" @if(($val->id == $post->Month['id'])) checked="checked" @endif value="{{$val->id}}" name="month[]" id="monthly_{{$val->id}}">
                        <span class="cr">
